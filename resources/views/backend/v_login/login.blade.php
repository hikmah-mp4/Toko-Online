<!DOCTYPE html>
<html dir="ltr"> <!-- ltr->left to right mengatur arak teks dari kiri ke kanan-->
...
<head>
    ...
    <!-- Favicon icon disesuaikan bagian href-->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('image/icon_univ_bsi.png') }}">
    <title>Toko Online</title>
    <!-- Custom CSS bagian yang diubah-->
...
<body>
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <!--disesuaikan bagian src -->
                        <span class="db"><img src="{{ asset('backend/images/logo.png') }}" alt="logo" /></span>
                    </div>
                    <!-- Form, coding penyesuaian dengan login-old.blade.php-->
                    <!-- error -->
    ...
    <!-- ============================================================== -->
    <!-- All Required js bagian yang diubah-->
    <!-- ============================================================== -->
